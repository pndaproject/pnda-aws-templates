...
def create(template_data, cluster, flavor, keyname, no_config_check, branch, existing_machines_def_file):
...
def expand(template_data, cluster, flavor, old_datanodes, old_kafka, keyname, branch, existing_machines_def_file):
    keyfile = '%s.pem' % keyname
...
def main():
    ...
    console_dns = create(template_data, pnda_cluster, flavor, keyname, no_config_check, branch, existing_machines_def_file)
